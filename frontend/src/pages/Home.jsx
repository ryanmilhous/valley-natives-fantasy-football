...
const HeaderWithTooltip = ({ children, tooltip, onClick, sortColumn }) => {
  ...
  const handleMouseEnter = () => {
    if (triggerRef.current) {
      ...
      setPosition({
        top: rect.top - 8,  // Position just above the element
...
function Home() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* All-Time Standings */}
      <div className="relative overflow-visible rounded-2xl sm:rounded-3xl bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 p-1">
        <div className="bg-slate-900/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-white/10">
          ...
          <div className="overflow-x-auto overflow-y-visible rounded-xl -mx-4 sm:mx-0 px-4 sm:px-0">
